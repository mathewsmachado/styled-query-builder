...
describe('breakpoint', () => {
  ...
  it('should accept breakpoints and return a function on the first invocation', () => {
    expect(breakpoints).toStrictEqual(expect.any(Function));
  });

  it('should receive a media query type and a size as a single value and return a string with the given media query', () => {
  ...
  it('should receive a media query type with the "between" value and a size as an array and return a string with the given media query', () => {
  ...
  it('should receive a media query type, a size and an antiOverlap and return a string with the given media query', () => {
    expect(breakpoints('below', 'sm', 1)).toBe('(max-width: 575px)');
    expect(breakpoints('above', 576, '1')).toBe('(min-width: 577px)');
  });

  it('should throw an error if user choose "between" option and passes a "antiOverlap" value', () => {
